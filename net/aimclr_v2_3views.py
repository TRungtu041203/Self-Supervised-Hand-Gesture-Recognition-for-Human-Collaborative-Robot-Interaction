...
class AimCLR_v2_3views(nn.Module):
    ...
    def __init__(self, base_encoder=None, pretrain=True, feature_dim=128, queue_size=32768,
        ...
        # Set Bone pairs according to graph layout
        layout = 'ntu-rgb+d'
        if isinstance(graph_args, dict) and 'layout' in graph_args:
            layout = graph_args['layout']
        if layout == 'cobot':
            # COBOT bone connections: Convert from 0-based (graph.py) to 1-based (bone calculations)
            # Based on graph.py neighbor_link connections
            self.Bone = [
                # Arm and shoulder connections (0-based 42-47 -> 1-based 43-48)
                (43, 45), (45, 47), (44, 46), (46, 48), (43, 44),
                # Right hand connections (0-based 0-20 -> 1-based 1-21)
                (1, 2), (2, 3), (3, 4), (4, 5),
                (6, 7), (7, 8), (8, 9),
                (10, 11), (11, 12), (12, 13),
                (14, 15), (15, 16), (16, 17),
                (18, 19), (19, 20), (20, 21),
                # Right palm chain
                (1,6), (6,10), (10,14), (14,18), (1,18),
                # Left hand connections (0-based 21-41 -> 1-based 22-42)
                ...
                (39, 40), (40, 41), (41, 42),
                # Left palm chain
                (22,27), (27,31), (31,35), (35,39), (22,39)
            ]
        else:
            # Default to NTU-RGB+D bone connections (25 joints)
            self.Bone = [
